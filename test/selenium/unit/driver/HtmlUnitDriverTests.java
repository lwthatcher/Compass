 ...
 */
public class HtmlUnitDriverTests extends DriverTestPlan
{
    @Test
    public void test_HtmlUnit_CanLoadLocalFiles()
    {
        //Open the page
    ...
    @Test
    public void test_HtmlUnit_CanAccessExternalSites()
    {
    ...
    @Test
    public void test_HtmlUnit_CanAccessLocalServer()
    {
    ...
    {
        driver = SupportedDriver.HtmlUnit.getDriver();
    }
}
