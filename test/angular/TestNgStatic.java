...
/**
 * Created by lthatch1 on 3/5/2015.
 *
 * @author Lawrence Thatcher
 */
public class TestNgStatic extends AngularTestPlan
{
    ...
    {
        WebElement element = driver.findElement(ByAngular.ng_options(animals));
    ...
    {
        List<WebElement> elements = driver.findElements(ByAngular.ng_options(animals));
    ...
    public void test_clickOnOption_viaFindAll()
    {
        ...
        elements = driver.findElements(ByAngular.ng_options(animals));
        assert elements.get(0).getTagName().equals("option");
...
//        assert exists.getText().equals("");
//
//        WebElement element = driver.findElement(ByAngular.ng_options(animals).value("10"));
//        element.click();
//
//        price = driver.findElement(ng.binding("selectedItem.price | currency"));
//        exists = driver.findElement(ng.binding("selectedItem.exists"));
...
//        List<WebElement> elements = driver.findElements(ByAngular.ng_options(ids).value("0"));
...
//    {
//        WebElement element = driver.findElement(ByAngular.ng_options(animals).label("cat"));
//        assert element.getTagName().equals("option");
...
//    {
//        WebElement element = driver.findElement(ByAngular.ng_options(animals).label("Big Bird"));
//        assert element.getTagName().equals("option");
...
//    {
//        List<WebElement> elements = driver.findElements(ByAngular.ng_options(animals).label("Dragon"));
