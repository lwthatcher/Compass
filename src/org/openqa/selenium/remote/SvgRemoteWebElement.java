 ...
 */
public class SvgRemoteWebElement extends RemoteWebElement implements WebElement
{
    private RemoteWebElement element;

    public SvgRemoteWebElement(WebElement e)
    {
    ...
    public List<SvgRemoteWebElement> getNeighborNodes()
    {
        ByNeighborNode by = new ByNeighborNode(getDriver(),element);
        List<WebElement> neighbors = (List<WebElement>)by.findElements(null);
        List<SvgRemoteWebElement> result = new ArrayList<SvgRemoteWebElement>();
        for (WebElement neighbor : neighbors)
        {
            result.add(new SvgRemoteWebElement(neighbor));
        }
        return result;
    }
    ...
    public List<WebElement> findElements(By by)
    {
        ...
        {
            result.add(new SvgRemoteWebElement(e));
        }
        return result;
    }

    @Override
    public SvgRemoteWebElement findElement(By by)
    {
